                ...
                <ModalBody>
                    <Flex direction='column' align='center'>
                        ...
                        <Flex mt='.5em' align='center' gap={1} color='#3A3A3A'>
                            ...
                            <Text fontSize='.8em' fontWeight={500}>Ogba, Lagos</Text>
                        </Flex>
                    </Flex>
                    <Box mt='1.5em' fontSize='.9em'>
                        <Text fontWeight={500}>PRICE: <Text as='b' color='#11A746'>0.02ETH</Text></Text>
                        <Text fontWeight={500} my='1em'>DURATION: <Text as='b' color='#F2471C'>1 Day</Text></Text>
